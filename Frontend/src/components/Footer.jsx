    ...
    <div>
      ...
      <footer className="footer footer-horizontal footer-center text-base-content rounded p-10 dark:bg-slate-900 dark:text-white">
        <nav className="grid grid-flow-col gap-4">
          <a href="/" className="link link-hover hover:scale-110">Home</a>
          <a href="/course" className="link link-hover hover:scale-110">Courses</a>
          <a href="/contact" className="link link-hover hover:scale-110">Contact</a>
          <a href="/about" className="link link-hover hover:scale-110">About us</a>
        </nav>
          ...
          <div className="grid grid-flow-col gap-4">
            ...
            <a href="https://twitter.com/yourProfile" target="_blank" rel="noopener noreferrer">
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current text-black dark:text-white hover:scale-110 transition-transform"
              >
            ...
            {/* YouTube */}
            <a href="https://youtube.com/@Depline9" target="_blank" rel="noopener noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            {/* Facebook */}
            <a href="https://facebook.com/share/v//19GPBg1hoe/" target="_blank" rel="noopener noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
